        ...
        <Form @submit="submitForm">
          <div id="modal-root">
            <div class="ly_wrap dimmed en_US ua_win">
              <div class="ly_common ly_page ly_member_add freeplan freeplan" style="
                /* opacity: 0; */
            ">
                <div class="tit_box">
                ...
                <div class="scroller">
                  ...
                  <div class="fm_members group_box">
                    ...
                    <div class="body">
                      ...
                      <div class="field">
                        <i class="hd">Function <div class="tooltip_cover">
                            <a href="#" class="ico_help">help</a>
                          </div>
                          <div class="tooltip_cover">
                            <a href="#" class="ico_free_plan">
                              <i class="blind">HELP</i>
                            </a>
                          </div>
                        </i>
                        <div class="box fm_func ui_freeplan">
                          <div class="func">
                            <span class="label">Message</span>
                            <input type="checkbox" class="lw_toggle" id="func_msg" disabled="" checked="">
                            <label for="func_msg">toggle button</label>
                          </div>
                          <div class="func">
                            <span class="label">
                              <i>Subfeatures</i>Note </span>
                            <input type="checkbox" class="lw_toggle" id="func_note" disabled="" checked="">
                            <label for="func_note">toggle button</label>
                          </div>
                          <div class="func">
                            <span class="label">
                              <i>Subfeatures</i>Schedule </span>
                            <input type="checkbox" class="lw_toggle" id="func_calendar" disabled="" checked="">
                            <label for="func_calendar">toggle button</label>
                          </div>
                          <div class="func">
                            <span class="label">
                              <i>Subfeatures</i>Task </span>
                            <input type="checkbox" class="lw_toggle" id="func_task" disabled="" checked="">
                            <label for="func_task">toggle button</label>
                          </div>
                          <div class="func">
                            <span class="label">
                              <i>Subfeatures</i>Folder </span>
                            <input type="checkbox" class="lw_toggle" id="func_folder" disabled="" checked="">
                            <label for="func_folder">toggle button</label>
                          </div>
                        </div>
                      </div>
                      <button type="button" class="opt_toggle">Advanced </button>
                      <ul class="func_box minor" style="">
                        <li class="func disabled">
                          <i class="hd">Grant permission for group feature to the master</i>
                          <p>Master can set whether to enable or disable the message/note/calendar/folder features.</p>
                          <input type="checkbox" class="lw_toggle" id="master_modify" disabled="" checked="">
                          <label for="master_modify">toggle button</label>
                        </li>
                        <li class="func">
                          <i class="hd">Send group notifications to all members</i>
                          <p> Notification messages will be sent to all members when any change occurs to the group.</p>
                          <input type="checkbox" class="lw_toggle" id="all_member_get_notify" checked="">
                          <label for="all_member_get_notify">toggle button</label>
                        </li>
                        <li class="func">
                          <i class="hd">Disclose group</i>
                          <p> When set to private, it does not appear in non-members' group list and auto-complete.</p>
                          <input type="checkbox" class="lw_toggle" id="group_public_private" checked="">
                          <label for="group_public_private">toggle button</label>
                        </li>
                      </ul>
                    </div>
                  </div>
